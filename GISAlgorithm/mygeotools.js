...
/**
 * 点和面关系
 * @param point geojson格式中点的坐标
 * @param polygon geojson格式中面的坐标
 * 
...
* @param center 中心点
* @param radius 半径，单位米
* @param vertices 返回圆面点的个数，默认64
*
* @return coords geojson格式中面的坐标
*/
