...
4. 场景丰富的、可以直接使用的调用示例，比接口是否简洁、文档是否详细更重要。
5. 用户觉得地图API是否好用的影响因素，从高到低排序：能不能解决问题、有没有bug、有没有丰富的示例、技术支持是否到位、文档是否清晰。
...
原文地址：[http://gisarmory.xyz/blog/index.html?blog=GISerSolution](http://gisarmory.xyz/blog/index.html?blog=GISerSolution)
